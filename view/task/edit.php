...
<form action="update.php" method="post" autocomplete="off">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" name="id" readonly class="form-control-plaintext" id="staticEmail" value="<?= $detail["id"]?>">
    </div>
  </div>
  <div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Tarea</label>
    <div class="col-sm-10">
      <input type="text" name="Title" class="form-control" id="inputPassword" value="<?= $detail["title"]?>">
    </div>
  </div>
  <div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Descripción</label>
    <div class="col-sm-10">
      <input type="text" name="Description" class="form-control" id="inputPassword" value="<?= $detail["description"]?>">
    </div>
  </div>
    <input type="submit" value="Actualizar" class="btn btn-success">
    <a href="show.php?id=<?= $detail["id"]?>" class="btn btn-danger">Cancelar</a>
  </div>
</form>
